    ...
    protected function image($user_id)
    {
        if ($this->images != null)
        {
            foreach ($this->images as $image)
            {
                ...
                $optimizerChain->optimize(public_path('/').$galleryImage->big_image);
//        package spatie/laravel-image-optimizer
                ImageOptimizer::optimize(public_path('/').$galleryImage->big_image);
            }
        }
    }
...
//        $optimizerChain = OptimizerChainFactory::create();
//        $optimizerChain->optimize(asset($name));

//        package spatie/laravel-image-optimizer
//        ImageOptimizer::optimize(asset($name));
        return $name;
    }
