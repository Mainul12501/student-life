                    ...
                    <div>
                        ...
                        <div class="tab-content" id="tabContent">
                            <div class="tab-pane fade show active" id="image" role="tabpanel" aria-labelledby="image-tab">
                                <div class="row mt-5">
                                    <div class="col-12">
                                        <h2 class="text-center orelega-one fw-bold f-s-36 text-orange">Image Gallary Of {{ $user->name }}</h2>
                                    </div>
                                </div>
                                <div class="row" id="printImages">
                                    ...
                                    @else
                                        <span class="text-danger f-s-25 text-center orelega-one text-capitalize" style="margin-top: 150px">there's no photo of {{ $user->name }} saved in our database.</span>
                                    @endif
                                </div>
                                @if(count($gallery)>20)
                                    <div class="row mt-4">
                            ...
                            <div class="tab-pane fade" id="audio" role="tabpanel" aria-labelledby="audio-tab">
                                <div class="row mt-5">
                                    <div class="col-12">
                                        <h2 class="text-center orelega-one fw-bold f-s-36 text-orange">Audio Gallary Of {{ $user->name }}</h2>
                                    </div>
                                </div>
                                <div class="row" id="">
                                    @php($y = 0)
                                    @if(count($galleryAudios)> 0)
                                        ...
                                        @endforeach
                                    @else
                                        <span class="text-danger f-s-25 text-center orelega-one text-capitalize" style="margin-top: 150px">there's no Audio uploaded by {{ $user->name }}.</span>
                                    @endif
                                </div>
                            </div>
                            <div class="tab-pane fade" id="video" role="tabpanel" aria-labelledby="video-tab">
                                <div class="row mt-5">
                                    <div class="col-12">
                                        <h2 class="text-center orelega-one fw-bold f-s-36 text-orange">Video Gallary Of {{ $user->name }}</h2>
                                    </div>
                                </div>
                                <div class="row" >
                                    @php($z = 0)
                                    @if(count($galleryVideos)> 0)
                                        ...
                                        @endforeach
                                    @else
                                        <span class="text-danger f-s-25 text-center orelega-one text-capitalize" style="margin-top: 150px">there's no Video uploaded by {{ $user->name }}.</span>
                                    @endif
                                </div>
                            </div>
                        </div>
...
{{--                        <img src="{{ asset('/') }}front/img/home-isotop-img/gro-3.jpg" class="gallary-img-size img-fluid" alt="">--}}
{{--                    </a>--}}
{{--                </div>--}}
    ...
    <script>
        $('#userGalleryLoadMore').click(function () {
            ...
            $.ajax({
                method : 'GET',
                dataType : 'JSON',
                url : '/get-more-user-gallery-image/'+userid,
