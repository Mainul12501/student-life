            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div>
                        ...
                        <input type="file" wire:model="profile_image" class="form-control mt-2 show-me hide-me">
                    </div>
                    <div class="py-2">
                        ...
                        <div class="d-grid col-6 mx-auto mt-2">
                            {{--                                                    <a href="{{route('user-gallery')}}" wire:click.prevent="showUserGallery({{ Auth::id() }})" class="btn btn-orange">View All Images</a>--}}
                            <p class="text-capitalize text-center text-orange">please input gallery images from Dashboard menu...</p>
                        </div>
                    </div>
                </div>
            </div>
